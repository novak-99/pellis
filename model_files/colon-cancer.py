...
train_test_val = get_data(root_dir, "../colon_dataset/colon_cancer.csv", transform)

train_val, test_set = torch.utils.data.random_split(lengths=[9000,1000], dataset=train_test_val)

train_set, val_set = torch.utils.data.random_split(lengths=[8000,1000], dataset=train_val)
