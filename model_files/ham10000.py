...
train_test_val = get_data(root_dir, "../ham10000/labels.csv", transform)

train_val, test_set = torch.utils.data.random_split(lengths=[9015,1000], dataset=train_test_val)

train_set, val_set = torch.utils.data.random_split(lengths=[8015, 1000], dataset=train_val)
